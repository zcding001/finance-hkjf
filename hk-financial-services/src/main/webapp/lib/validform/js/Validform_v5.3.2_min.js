...
(function(d, f, b) {
	...
	var e = {
		...
		w : {
			...
			"*6-16":"请填写6到16位任意字符！",
			"n":"请填写正整数值！",
			"n1":"请填写1-99999999范围内的保留2位小数的数字！",
			"n2":"请填写数字！",
			"n3":"请填写有效年利率(保留两位小数)！",
			"n6-16":"请填写6到16位数字！",
			"ns6-16":"请输入6至16位英文字母或数字！",
			"ps6-16":"请输入6至16位英文字母或数字！",
			"psnew6-16":"请输入6至16位字母数字组合！",
			"n16-19":"请填写16到19位的卡号！",
			"s":"不能输入特殊字符！",
			"s6-18":"请填写6到18位字符！",
			"p":"请填写邮政编码！",
	...
	a.util = {
		dataType : {
			...
			"*6-16" : /^[\w\W]{6,16}$/,
			n : /^\d+$/,
			"n1" : /^(^[1-9]{1}[0-9]{0,7}|(^[1-9]{1}[0-9]{0,8}\.[0-9]{1,2}$)$)$/,
			"n2" : /^(^[1-9]{1}[0-9]{0,9}(\.{0,1}[0-9]{1,2}|)$)|(^[1-9]{0,9}[0]{1}(\.{0,1}[0-9]{1,2}|)$)$/,
			"n3" : /^(^(0\.0[1-9]$)|(^0\.[1-9][0-9]{0,1}$)$)|(^[1-9]{1}[0-9]{0,8}\.{0,1}[0-9]{0,2}$)$/,
			"n6-16" : /^\d{6,16}$/,
			"ns6-16":/^[a-zA-Z0-9]{6,16}$/,
			"ps6-16":/^[\S]{6,16}$/,
			"psnew6-16":/^(?![0-9]+$)(?![a-zA-Z]+$)[0-9A-Za-z]{6,16}$/,
			"n16-19" : /^\d{16,19}$/,
			s : /^[\u4E00-\u9FA5\uf900-\ufa2d\w\.\s]+$/,
	...
	function c() {
		...
		j = d(
				'<div id="Validform_msg"><div class="Validform_title">' + e.tit + '<a class="Validform_close" href="javascript:void(0);">&chi;</a></div><div class="Validform_info"></div><div class="iframe"><iframe frameborder="0" scrolling="no" height="100%" width="100%"></iframe></div></div>')
				.appendTo("body");
