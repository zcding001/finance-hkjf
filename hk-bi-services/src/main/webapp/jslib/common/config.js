...
CONFIG.interface = jQuery.extend({
    ...
    //钱袋子统计
    searchTransRecordList       : HOST + 'qdzCountController/searchTransRecordList',
    //注册转换率统计
    staUserCvr		            : HOST + 'userStaController/staUserCvr',
    //邀请统计
    staInvite   		        : HOST + 'userStaController/staInvite',
    //新老用户投资分布
    staInvestDis		        : HOST + 'userStaController/staInvestDis',
    //标的募集统计
    staFunProDis                : HOST + 'staProController/staFunProDis',
    //投资记录查询统计
    staFunInvest                : HOST + 'staProController/staFunInvest',
    //标的查询统计
    staFunBid                   : HOST + 'staProController/staFunBid',
    //推荐奖发放统计
    findRecomendSendCountList     : HOST + 'recommendCountController/findRecomendSendCountList',
    //推荐奖金统计
    findRecomendEarnCountList     : HOST + 'recommendCountController/findRecomendEarnCountList',
    //充值提现统计
    findPayRecordCountList       : HOST + 'paymentCountController/findPayRecordCountList',
    //红包统计
    findOfflinePacketCountList  : HOST + 'vasCountController/findOfflinePacketCountList',
    //积分消费统计
    pointPayCountList   : HOST + 'pointCountController/pointPayCountList',
    //平台数据统计
    findPlatformCountList  : HOST + 'platformCountController/findPlatformCountList',
    //平台资金流动统计
    findTransfterCountList : HOST + 'platformCountController/findTransfterCountList',
    //平台运营统计
    staFunPlatformAddup         : HOST + 'staProController/staFunPlatformAddup',
    //卡券统计
    staCouponDetailList        : HOST + 'vasCountController/staCouponList',
    //卡券收益统计
    staCouponProfitList        : HOST + 'vasCountController/staCouponProfitList'
