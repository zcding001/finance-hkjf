...
import static com.hongkun.finance.user.support.security.SecurityConstants.AUTH_URLS;
...
public class PrivilegeController {
    ...
    public ResponseEntity scannedPrivileges(){
        return new ResponseEntity(SUCCESS, JedisClusterUtils.getList(AUTH_URLS,0,-1));
    }
