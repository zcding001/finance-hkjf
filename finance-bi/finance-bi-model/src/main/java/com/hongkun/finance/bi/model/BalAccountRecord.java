...
/**
 * @Project       : finance
 * @Program Name  : com.hongkun.finance.bi.model.BalAccountRecord.java
 * @Class Name    : BalAccountRecord.java
 * @Description   : GENERATOR VO类
 * @Author        : generator
 */
public class BalAccountRecord extends BaseModel {
	...
	public BalAccountRecord(){
	}

	public BalAccountRecord(java.lang.Integer id){
		this.id = id;
	}
