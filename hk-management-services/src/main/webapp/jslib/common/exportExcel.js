...
function exportExcel(currentName,tableid) { 
	if(commonUtil.isEmpty(tableid)){
		tableid = 'mDataTable';
	}
	filename = currentName+new Date().toLocaleDateString();
    if(getExplorer()=='ie')  
    {  
...
var tableToExcel = (function() {  
    ...
    return function(table, name) {  
       ...
       document.getElementById("excelBtn").href = uri + base64(format(template, ctx));
