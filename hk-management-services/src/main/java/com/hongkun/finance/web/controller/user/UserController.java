...
public class UserController {
	...
	public ResponseEntity<?> userList(Pager pager, UserVO userWithDetailVO) {
	    if(Objects.equals(userWithDetailVO.getType(),-999)){
            userWithDetailVO.setTypes(Arrays.asList(UserConstants.USER_TYPE_GENERAL, UserConstants.USER_TYPE_ENTERPRISE, UserConstants.USER_TYPE_TENEMENT, UserConstants.USER_TYPE_ESCROW_ACCOUNT));
        }
	...
	public ResponseEntity<?> userAccountMoney(Pager pager, UserVO userVO) {
        if(Objects.equals(userVO.getType(),-999)){
            userVO.setTypes(Arrays.asList(UserConstants.USER_TYPE_GENERAL, UserConstants.USER_TYPE_ENTERPRISE, UserConstants.USER_TYPE_TENEMENT, UserConstants.USER_TYPE_ESCROW_ACCOUNT));
        }
	 ...
	 */
	@RequestMapping("findPropertyDicDataList")
	@ResponseBody
