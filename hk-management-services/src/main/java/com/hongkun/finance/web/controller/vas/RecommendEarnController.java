...
public class RecommendEarnController {
	 ...
	 *  @return
	 *  @return         : ResponseEntity<?>;
	 *  @Creation Date  : 2018年9月27日 上午11:30:39;
	 *  @Author         : yanbinghuang@hongkun.com.cn 黄艳兵;
	 */
    @RequestMapping("/findRecommendEarnInfo")
    @ResponseBody
    public ResponseEntity<?> findRecommendEarnInfo(RecommendEarnVO recommendEarnVO, Pager pager) {
        return recommendEarnFacade.findRecommendEarn(recommendEarnVO, pager);
    }
	/**
    ...
    /**
     *  @Description    : 查询推荐人的奖励明细信息
     *  @Method_Name    : searchRecommendEarnByUserId;
     *  @param recommendEarnVO
     *  @param pager
     *  @return
     *  @return         : ResponseEntity<?>;
     *  @Creation Date  : 2018年12月14日 上午10:47:42;
     *  @Author         : yanbinghuang@hongkun.com.cn 黄艳兵;
     */
    @RequestMapping("/searchRecommendEarnByUserId")
    @ResponseBody
    public ResponseEntity<?> searchRecommendEarnByUserId(RecommendEarnVO recommendEarnVO, Pager pager) {
        return recommendEarnFacade.searchRecommendEarnByUserId(recommendEarnVO, pager);
    }
