...
public class ExceptionResponse {
    ...
    @ResponseBody
    public Map<String,Object> handlerGeneralException(RuntimeException exception, WebRequest request, HttpServletResponse response) {
        //解析错误信息
       ...
       return AppResultUtil.mapOfResponseEntity(ResponseEntity.error(returnMsg));
    }
