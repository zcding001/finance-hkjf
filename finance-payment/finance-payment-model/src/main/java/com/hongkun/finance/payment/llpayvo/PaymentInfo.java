...
/**
 * @Description : 支付信息bean
 * @Project : finance-payment-model
 * @Program Name : com.hongkun.finance.payment.llpayvo.PaymentInfo.java
 * @Author : yanbinghuang
 */
public class PaymentInfo implements Serializable {
	...
	private String oid_partner;// 支付交易商户编号
