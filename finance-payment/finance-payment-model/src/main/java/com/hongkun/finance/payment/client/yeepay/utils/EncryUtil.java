...
public class EncryUtil {
	 ...
	 */
	public static boolean verifyCallbackHmac(String keyValue,String[] stringValue, String hmacFromYeepay) throws UnsupportedEncodingException {
...
//			stringValue[i] = new String(stringValue[i].getBytes("8859_1"),"GB2312");
	 ...
	 * @throws UnsupportedEncodingException 
	 */
	public static boolean verifyCallbackHmac_safe(String keyValue,String[] stringValue, String hmac_safeFromYeepay) throws UnsupportedEncodingException {
	 ...
	 * @throws UnsupportedEncodingException 
	 */
	public static boolean verifyCallbackHmac_safe_wy(String KeyValue,String[] stringValue, String hmac_safeFromYeepay) throws UnsupportedEncodingException {
