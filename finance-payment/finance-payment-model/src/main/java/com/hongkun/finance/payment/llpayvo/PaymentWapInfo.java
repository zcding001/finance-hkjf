...
/**
 * @Description : 支付信息WAP端bean
 * @Project : finance-payment-model
 * @Program Name : com.hongkun.finance.payment.llpayvo.PaymentWapInfo.java
 * @Author : yanbinghuang
 */
public class PaymentWapInfo implements Serializable {
	...
	private String lasttime_sendmsg; // 最后发手机验证码时间
