...
public class FinPaymentFacadeImplTest {
    ...
    public void paymentVerificationCode(){  //短验
    	...
    	rechargeCash.setPayChannel(PayChannelEnum.fromChannelCode(Integer.parseInt("6")));
	  ...
	  @Test
	  public void confirmPay(){ //确认支付
	  	RechargeCash rechargeCash = new RechargeCash();
	  	rechargeCash.setOperateType(1);
	  	rechargeCash.setPayUnionCode("20180522114641013031107052478791");
	  	...
	  	rechargeCash.setPayStyle(PayStyleEnum.RZ.getType());
	  	rechargeCash.setBankCode("ICBC");
	  	rechargeCash.setPaymentFlowId("PY1010002018101814542281228867");
