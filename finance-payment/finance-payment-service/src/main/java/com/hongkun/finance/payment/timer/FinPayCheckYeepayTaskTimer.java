 ...
 */
public class FinPayCheckYeepayTaskTimer implements SimpleJob {

    private static final Logger logger = LoggerFactory.getLogger(FinPayCheckYeepayTaskTimer.class);
    @Autowired
    private FinPayCheckAccountService finPayCheckAccountService;
    
    @Override
    public void execute(ShardingContext shardingContext) {
    	logger.info("FinPayCheckYeepayTaskTimer execute method start.");
    	...
    	finPayCheckAccountService.excuteYeepayReconciliation(settleDate);
