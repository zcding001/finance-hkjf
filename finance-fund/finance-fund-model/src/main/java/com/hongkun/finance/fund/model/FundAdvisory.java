...
/**
 * @Project       : finance
 * @Program Name  : com.hongkun.finance.fund.model.FundAdvisory.java
 * @Class Name    : FundAdvisory.java
 * @Description   : GENERATOR VO类
 * @Author        : generator
 */
public class FundAdvisory extends BaseModel {
	...
	public FundAdvisory(java.lang.Integer id){
		this.id = id;
	}
