...
/**
 * @Project       : finance
 * @Program Name  : com.hongkun.finance.fund.model.FundInfo.java
 * @Class Name    : FundInfo.java
...
public class FundInfo extends BaseModel {
	...
	//【非数据库字段，查询时使用】
	private String customizeTimeStr;
	...
	public FundInfo(java.lang.Integer id){
		this.id = id;
	}
	...
	public void setStepValue(java.math.BigDecimal stepValue) {
	...
	public String getCustomizeTimeStr() {
		return customizeTimeStr;
	}

	public void setCustomizeTimeStr(String customizeTimeStr) {
		this.customizeTimeStr = customizeTimeStr;
	}
}
