...
/**
 * @Project       : finance
 * @Program Name  : com.hongkun.finance.user.model.BidTransferManual.java
 * @Class Name    : BidTransferManual.java
 * @Description   : GENERATOR VO类
 * @Author        : generator
 */
public class BidTransferManual extends BaseModel {
	...
	private java.lang.Integer firstInvestId;
	...
	//【非数据库字段，查询时使用】
	private java.lang.Integer investState;

	private java.lang.Integer oldState;

	private java.lang.Integer buyerHoldDays;
 
	public BidTransferManual(){
	}

	public BidTransferManual(java.lang.Integer id){
		this.id = id;
	}

	public BidTransferManual(Integer oldInvestId, BigDecimal creditorAmount, Integer transferDays) {
		this.oldInvestId = oldInvestId;
		this.creditorAmount = creditorAmount;
		this.transferDays = transferDays;
		this.transferRate = new BigDecimal(100);
	}
	...
	public java.lang.Integer getFirstInvestId() {
		return firstInvestId;
	}
	public void setFirstInvestId(java.lang.Integer firstInvestId) {
